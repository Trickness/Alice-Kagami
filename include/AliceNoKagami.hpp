...
class AliceNoKagami{
    public:
        ...
        std::string GetHTMLSync(const char* URI,  Wonderland::CachePolicy Policy = Wonderland::CachePolicy::FIRST_FROM_CACHE);
        void GetParsedContentAsync(const char* URI, Wonderland::CachePolicy Policy = Wonderland::CachePolicy::FIRST_FROM_CACHE, Wonderland::NetworkCallback _Callback = nullptr);
